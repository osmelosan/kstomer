export const es = {
  ...
  resellers: {
    ...
    detail: {
      metaTitle: "{{name}} — Distribuidor — Kstomer",
      back: "Volver a distribuidores",
      notFoundTitle: "Distribuidor no encontrado",
      notFoundBody: "Este socio no existe o ha sido archivado.",
      kpis: {
      ...
      labels: {
        ...
        onboardedAt: "Socio desde",
        stage: "Etapa",
        closeDate: "Cierre previsto",
        amount: "Importe",
      },
      status: { won: "Ganado", lost: "Perdido" },
      empty: { activeDeals: "Sin operaciones activas.", history: "Sin operaciones cerradas." },
      notes: {
        placeholder: "Añade una nota interna sobre este socio…",
        pending: "Cambios pendientes",
        saving: "Guardando…",
