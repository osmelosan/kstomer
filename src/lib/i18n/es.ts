export const es = {
  ...
  dashboard: {
    ...
    newBadge_one: "{{count}} NUEVO",
    newBadge_other: "{{count}} NUEVOS",
    vsLastMonth: "{{delta}}% vs mes pasado",
    conversionRate: "Tasa de conversión",
    toMonitor: "A vigilar",
    avgCycle_one: "Ciclo medio: {{count}} día",
    avgCycle_other: "Ciclo medio: {{count}} días",
  ...
  settings: {
    ...
    integrations: {
      ...
      nukiDesc: "Conecta tu cuenta Nuki para otorgar y revocar accesos a tus cerraduras.",
      nukiSelectCompany: "Selecciona una empresa (arriba a la izquierda) para conectar Nuki.",
      nukiTokenPlaceholder: "Pega tu API Token de Nuki",
      nukiTokenHint: "Genéralo en Nuki Web → MENU → API. Se guarda cifrado y solo se usa en el servidor.",
      nukiConnectedAs: "Conectado · token ••••{{last4}}",
      nukiDisconnect: "Desconectar",
      nukiConnected: "Nuki conectado.",
      nukiDisconnected: "Nuki desconectado.",
    },
  },
  apps: {
    metaTitle: "Apps — Kstomer",
    title: "Apps",
    subtitle: "Aplicaciones e integraciones para ampliar Kstomer.",
    nukiName: "Nuki Smart Lock",
    nukiDesc: "Otorga y revoca accesos a tus cerraduras inteligentes Nuki.",
    open: "Abrir",
    comingSoon: "Más apps próximamente",
    backToApps: "Volver a Apps",
  },
  nuki: {
    metaTitle: "Accesos — Kstomer",
    title: "Accesos",
    subtitle: "Gestiona los accesos a tus cerraduras inteligentes Nuki.",
    selectCompany: "Selecciona una empresa para gestionar sus accesos.",
    notConnectedTitle: "Nuki no está conectado",
    notConnected: "Conecta tu cuenta Nuki para empezar a otorgar accesos.",
    goToSettings: "Ir a Integraciones",
    locks: "Cerraduras",
    noLocks: "No se han encontrado cerraduras en esta cuenta Nuki.",
    refresh: "Actualizar",
    grantAccess: "Dar acceso",
    batteryLow: "Batería baja",
    grants: "Accesos otorgados",
    noGrants: "Todavía no has otorgado ningún acceso.",
    statusActive: "Activo",
    statusRevoked: "Revocado",
    revoke: "Revocar",
    until: "hasta",
    revokeTitle: "Revocar acceso",
    revokeConfirm: "¿Seguro que quieres revocar «{{name}}»? La persona dejará de tener acceso.",
    contactCardTitle: "Accesos Nuki",
    contactNoGrants: "Este contacto no tiene ningún acceso todavía.",
    toast: {
      granted: "Acceso otorgado.",
      revoked: "Acceso revocado.",
    },
    bulk: {
      button: "Acceso en masa",
      title: "Dar acceso en masa",
      subtitle: "Selecciona contactos para enviarles una invitación de la app Nuki a su email.",
      contacts: "Contactos",
      noContacts: "No hay contactos con email en esta empresa.",
      searchContacts: "Buscar contacto…",
      selectAll: "Seleccionar todos",
      selectedCount: "{{count}} seleccionados",
      submit: "Dar acceso a {{count}}",
      errorNoContacts: "Selecciona al menos un contacto.",
      createdCount: "{{count}} accesos creados.",
      failedCount: "{{count}} fallidos",
      partial: "{{created}} creados, {{failed}} fallidos.",
      done: "Hecho",
    },
    dialog: {
      title: "Dar acceso a la cerradura",
      subtitle: "Crea un código de teclado o una llave de app con vigencia opcional.",
      lock: "Cerradura",
      lockPlaceholder: "Elige una cerradura",
      type: "Tipo de acceso",
      typeKeypad: "PIN de teclado",
      typeAppKey: "Llave de app (invitación por email)",
      name: "Nombre",
      namePlaceholder: "p. ej. Cliente Juan Pérez",
      code: "Código (6 dígitos)",
      codeHint: "6 dígitos del 1 al 9 (sin ceros). Comunica el código a la persona.",
      email: "Email",
      emailHint: "Se enviará una invitación de Nuki a este email.",
      until: "Válido hasta (opcional)",
      untilHint: "Deja en blanco para un acceso sin fecha de caducidad.",
      submit: "Otorgar acceso",
      errorLock: "Selecciona una cerradura.",
    },
  },
  tasks: {
