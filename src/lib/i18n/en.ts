export const en = {
  ...
  dashboard: {
    ...
    avgCycle_one: "Avg. cycle: {{count}} day",
    avgCycle_other: "Avg. cycle: {{count}} days",
  ...
  contactDetail: {
    ...
    ai: {
      ...
      errorRate: "Too many requests. Please wait a moment.",
      errorCredits: "AI credits exhausted. Top up your workspace.",
      draftButton: "Draft follow-up",
      drafting: "Drafting…",
      draftDialogTitle: "Follow-up message",
      draftDialogDescription: "AI-generated — review before sending.",
      copy: "Copy",
      copied: "Copied!",
    },
  },
  ...
  settings: {
    ...
    integrations: {
      ...
      nukiDesc: "Connect your Nuki account to grant and revoke access to your locks.",
      nukiSelectCompany: "Select a company (top left) to connect Nuki.",
      nukiTokenPlaceholder: "Paste your Nuki API Token",
      nukiTokenHint: "Generate it in Nuki Web → MENU → API. Stored encrypted and used server-side only.",
      nukiConnectedAs: "Connected · token ••••{{last4}}",
      nukiDisconnect: "Disconnect",
      nukiConnected: "Nuki connected.",
      nukiDisconnected: "Nuki disconnected.",
    },
  },
  apps: {
    metaTitle: "Apps — Kstomer",
    title: "Apps",
    subtitle: "Apps and integrations to extend Kstomer.",
    nukiName: "Nuki Smart Lock",
    nukiDesc: "Grant and revoke access to your Nuki smart locks.",
    open: "Open",
    comingSoon: "More apps coming soon",
    backToApps: "Back to Apps",
  },
  nuki: {
    metaTitle: "Access — Kstomer",
    title: "Access",
    subtitle: "Manage access to your Nuki smart locks.",
    selectCompany: "Select a company to manage its access.",
    notConnectedTitle: "Nuki is not connected",
    notConnected: "Connect your Nuki account to start granting access.",
    goToSettings: "Go to Integrations",
    locks: "Locks",
    noLocks: "No locks found on this Nuki account.",
    refresh: "Refresh",
    grantAccess: "Grant access",
    batteryLow: "Battery low",
    grants: "Granted access",
    noGrants: "You haven't granted any access yet.",
    statusActive: "Active",
    statusRevoked: "Revoked",
    revoke: "Revoke",
    until: "until",
    revokeTitle: "Revoke access",
    revokeConfirm: "Revoke \"{{name}}\"? This person will no longer have access.",
    contactCardTitle: "Nuki access",
    contactNoGrants: "This contact has no access yet.",
    toast: {
    ...
    bulk: {
      button: "Bulk access",
      title: "Grant access in bulk",
      subtitle: "Select contacts to send them a Nuki app invitation by email.",
      contacts: "Contacts",
      noContacts: "No contacts with an email in this company.",
      searchContacts: "Search a contact…",
      selectAll: "Select all",
      selectedCount: "{{count}} selected",
      submit: "Grant to {{count}}",
      errorNoContacts: "Select at least one contact.",
      createdCount: "{{count}} accesses created.",
      failedCount: "{{count}} failed",
      partial: "{{created}} created, {{failed}} failed.",
      done: "Done",
    },
    dialog: {
      title: "Grant lock access",
      subtitle: "Create a keypad code or an app key, with an optional validity window.",
      lock: "Lock",
      lockPlaceholder: "Choose a lock",
      type: "Access type",
      typeKeypad: "Keypad PIN",
      typeAppKey: "App key (email invite)",
      name: "Name",
      namePlaceholder: "e.g. Client John Doe",
      code: "Code (6 digits)",
      codeHint: "6 digits from 1-9 (no zeros). Share the code with the person.",
      email: "Email",
      emailHint: "A Nuki invitation will be sent to this email.",
      until: "Valid until (optional)",
      untilHint: "Leave blank for access with no expiry date.",
      submit: "Grant access",
      errorLock: "Select a lock.",
    },
  },
  tasks: {
  ...
  accountArchived: {
    ...
    bodyWithDays:
      "This account is archived and will be permanently and irreversibly deleted in {{days}} days unless you restore it now.",
