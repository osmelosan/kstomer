export const en = {
  ...
  resellers: {
    ...
    detail: {
      metaTitle: "{{name}} — Reseller — Kstomer",
      back: "Back to resellers",
      notFoundTitle: "Reseller not found",
      notFoundBody: "This partner does not exist or has been archived.",
      kpis: {
      ...
      labels: {
        ...
        onboardedAt: "Partner since",
        stage: "Stage",
        closeDate: "Expected close",
        amount: "Amount",
      },
      status: { won: "Won", lost: "Lost" },
      empty: { activeDeals: "No active deals.", history: "No closed deals." },
      notes: {
