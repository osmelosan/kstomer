export const fr = {
  ...
  resellers: {
    ...
    detail: {
      metaTitle: "{{name}} — Revendeur — Kstomer",
      back: "Retour aux revendeurs",
      notFoundTitle: "Revendeur introuvable",
      notFoundBody: "Ce partenaire n'existe pas ou a été archivé.",
      kpis: {
      ...
      sections: {
        activeDeals: "Affaires en cours",
        history: "Historique des deals",
        notes: "Notes",
        coordinates: "Coordonnées",
        commercial: "Infos commerciales",
      ...
      actions: {
        ...
        call: "Appeler",
        website: "Site web",
        viewPipeline: "Voir dans le pipeline",
      },
      labels: {
        ...
        onboardedAt: "Partenaire depuis",
        stage: "Étape",
        closeDate: "Closing prévu",
        amount: "Montant",
      },
      status: { won: "Gagné", lost: "Perdu" },
      empty: { activeDeals: "Aucune affaire en cours.", history: "Aucun deal clôturé." },
      notes: {
        placeholder: "Ajoutez une note interne sur ce partenaire…",
        pending: "Modifications en attente",
        saving: "Sauvegarde…",
