export const fr = {
  ...
  dashboard: {
    ...
    newBadge_one: "{{count}} NOUVEAU",
    newBadge_other: "{{count}} NOUVEAUX",
    vsLastMonth: "{{delta}}% vs mois dernier",
    conversionRate: "Taux de conversion",
    toMonitor: "À surveiller",
    avgCycle_one: "Cycle moyen : {{count}} jour",
    avgCycle_other: "Cycle moyen : {{count}} jours",
  ...
  settings: {
    ...
    integrations: {
      ...
      nukiDesc: "Connectez votre compte Nuki pour accorder et révoquer des accès à vos serrures.",
      nukiSelectCompany: "Sélectionnez une entreprise (en haut à gauche) pour connecter Nuki.",
      nukiTokenPlaceholder: "Collez votre API Token Nuki",
      nukiTokenHint: "Générez-le dans Nuki Web → MENU → API. Il est stocké chiffré et utilisé uniquement côté serveur.",
      nukiConnectedAs: "Connecté · token ••••{{last4}}",
      nukiDisconnect: "Déconnecter",
      nukiConnected: "Nuki connecté.",
      nukiDisconnected: "Nuki déconnecté.",
    },
  },
  apps: {
    metaTitle: "Apps — Kstomer",
    title: "Apps",
    subtitle: "Applications et intégrations pour étendre Kstomer.",
    nukiName: "Nuki Smart Lock",
    nukiDesc: "Accordez et révoquez des accès à vos serrures connectées Nuki.",
    open: "Ouvrir",
    comingSoon: "D'autres apps bientôt disponibles",
    backToApps: "Retour aux Apps",
  },
  nuki: {
    metaTitle: "Accès — Kstomer",
    title: "Accès",
    subtitle: "Gérez les accès à vos serrures connectées Nuki.",
    selectCompany: "Sélectionnez une entreprise pour gérer ses accès.",
    notConnectedTitle: "Nuki n'est pas connecté",
    notConnected: "Connectez votre compte Nuki pour commencer à accorder des accès.",
    goToSettings: "Aller aux Intégrations",
    locks: "Serrures",
    noLocks: "Aucune serrure trouvée sur ce compte Nuki.",
    refresh: "Actualiser",
    grantAccess: "Accorder un accès",
    batteryLow: "Batterie faible",
    grants: "Accès accordés",
    noGrants: "Vous n'avez encore accordé aucun accès.",
    statusActive: "Actif",
    statusRevoked: "Révoqué",
    revoke: "Révoquer",
    until: "jusqu'au",
    revokeTitle: "Révoquer l'accès",
    revokeConfirm: "Voulez-vous vraiment révoquer « {{name}} » ? La personne n'aura plus accès.",
    contactCardTitle: "Accès Nuki",
    contactNoGrants: "Ce contact n'a encore aucun accès.",
    toast: {
    ...
    dialog: {
      ...
      lock: "Serrure",
      lockPlaceholder: "Choisissez une serrure",
      type: "Type d'accès",
      typeKeypad: "Code clavier (PIN)",
      typeAppKey: "Clé d'application (invitation par e-mail)",
      name: "Nom",
      namePlaceholder: "ex. Client Jean Dupont",
      code: "Code (6 chiffres)",
      codeHint: "6 chiffres de 1 à 9 (sans zéro). Communiquez le code à la personne.",
      email: "E-mail",
      emailHint: "Une invitation Nuki sera envoyée à cette adresse.",
      until: "Valable jusqu'au (optionnel)",
      untilHint: "Laissez vide pour un accès sans date d'expiration.",
      submit: "Accorder l'accès",
      errorLock: "Sélectionnez une serrure.",
    },
  },
  tasks: {
