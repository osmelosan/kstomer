...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The efficient, precise, no-noise CRM for solopreneurs: Kanban pipeline, contact book, task reminders and AI-assisted insights, all in one tool." },
      { property: "og:description", content: "The efficient, precise, no-noise CRM for solopreneurs: Kanban pipeline, contact book, task reminders and AI-assisted insights, all in one tool." },
      { name: "twitter:description", content: "The efficient, precise, no-noise CRM for solopreneurs: Kanban pipeline, contact book, task reminders and AI-assisted insights, all in one tool." },
